 ...
 **********************************************
  ...
  */
PImage[] imgSetOne= new PImage[30]  ;  // Declare variable "a" of type PImage
 ...
 void setSubject(){
  switch (step) {
    case 1:  textAlign(LEFT);
             ...
             break;
    case 2:  setSubjectAge() ;//shows the selection an waits for  input, should be renamed
             break;
    case 3:  textAlign(CENTER);
